                ...
                <div class="p-6">
                    <form action="{{ route('tugas.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
