...
<head>
    ...
    <style>
        ...
        /* Page loader */
        .page-loader {
            position: fixed; inset: 0; z-index: 9999; background: #f8f9ff;
        ...
        @media (prefers-reduced-motion: reduce) {
            .page-loader img, .page-loader .loader-dot { animation: none; opacity: 1; transform: scale(1); }
        }
        @keyframes float {
...
<body class="antialiased min-h-screen flex flex-col bg-background" x-data="{ mobileMenuOpen: false }">
    ...
    <header class="fixed top-0 w-full z-50 transition-all duration-300 bg-white/90 backdrop-blur-md shadow-sm border-b border-surface-container-high" id="main-header">
        ...
        <div x-show="mobileMenuOpen" x-cloak
             ...
             class="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-3 shadow-md">
            <a class="font-semibold text-sm text-on-surface-variant hover:text-primary transition-colors" href="#features" @click="mobileMenuOpen = false">Fitur</a>
            <a class="font-semibold text-sm text-on-surface-variant hover:text-primary transition-colors" href="#how-it-works" @click="mobileMenuOpen = false">Cara Kerja</a>
            <a class="font-semibold text-sm text-on-surface-variant hover:text-primary transition-colors" href="#preview" @click="mobileMenuOpen = false">Preview</a>
    ...
    <main class="flex-grow pt-16">
        <!-- Hero Section -->
        <section class="relative pt-16 pb-16 md:pb-32 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative w-full h-[250px] sm:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden glass-card p-4 flex items-center justify-center">
        ...
        <section class="py-16 md:py-24 bg-white" id="features">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2 bg-[#f6fafe] rounded-2xl p-6 md:p-8 shadow-soft border border-surface-container relative overflow-hidden group hover:shadow-md transition-all">
                        ...
                        <div class="relative z-10 h-full flex flex-col justify-between min-h-[160px] md:min-h-[180px]">
                            <div class="w-12 h-12 md:w-14 md:h-14 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-4 md:mb-6">
                    ...
                    <div class="bg-[#f6fafe] rounded-2xl p-6 md:p-8 shadow-soft border border-surface-container relative overflow-hidden group hover:shadow-md transition-all">
                        <div class="relative z-10 h-full flex flex-col justify-between min-h-[160px] md:min-h-[180px]">
                            <div class="w-12 h-12 md:w-14 md:h-14 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-4 md:mb-6">
                    ...
                    <div class="bg-[#f6fafe] rounded-2xl p-6 md:p-8 shadow-soft border border-surface-container relative overflow-hidden group hover:shadow-md transition-all">
                        <div class="relative z-10 h-full flex flex-col justify-between min-h-[160px] md:min-h-[180px]">
                            <div class="w-12 h-12 md:w-14 md:h-14 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-4 md:mb-6">
                                <span class="material-symbols-outlined text-2xl md:text-3xl">devices</span>
                            </div>
                            <div>
                    ...
                    <div class="md:col-span-2 bg-[#f6fafe] rounded-2xl p-6 md:p-8 shadow-soft border border-surface-container relative overflow-hidden group hover:shadow-md transition-all flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <section class="py-16 md:py-24 bg-[#f6fafe]" id="how-it-works">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="relative">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 relative z-10">
                        <!-- Step 1 -->
        ...
        <!-- Preview Section -->
        <section class="py-16 md:py-24 bg-primary text-white overflow-hidden" id="preview">
            <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
    ...
    <!-- Footer -->
    <footer class="bg-white border-t border-gray-100 pt-10 md:pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#features">Fitur</a>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#how-it-works">Cara Kerja</a>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#preview">Preview</a>
                    <a href="{{ route('login') }}" class="text-xs text-secondary hover:text-primary transition-colors">Login Portal</a>
                </div>
                <div class="flex flex-col gap-4">
                    <h5 class="font-bold text-sm text-on-surface">Navigasi</h5>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#features">Fitur Utama</a>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#how-it-works">Proses Kerja</a>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#preview">Dashboard Demo</a>
                </div>
                <div class="flex flex-col gap-4">
                    <h5 class="font-bold text-sm text-on-surface">Dukungan</h5>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="{{ route('login') }}">Portal Masuk</a>
                    <a class="text-xs text-secondary hover:text-primary transition-colors" href="#features">Dokumentasi</a>
                </div>
            </div>
            <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-xs text-secondary text-center md:text-left">
                    © {{ date('Y') }} Presence Teen. All rights reserved.
                </p>
                <div class="flex gap-4">
                    <a class="w-10 h-10 rounded-full bg-background flex items-center justify-center text-secondary hover:bg-gray-200 transition-colors" href="{{ route('login') }}">
                        <span class="material-symbols-outlined text-sm">login</span>
                    </a>
                    <a class="w-10 h-10 rounded-full bg-background flex items-center justify-center text-secondary hover:bg-gray-200 transition-colors" href="#features">
